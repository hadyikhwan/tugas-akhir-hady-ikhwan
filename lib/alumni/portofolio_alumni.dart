    ...
    (value) {
      value.docs.forEach((element) {
        ...
        experienceComponent[experienceComponent.length - 1].linkDocument =
            element['linkDocument'];
        experienceComponent[experienceComponent.length - 1].nameOfInstitution =
  ...
  await FirebaseFirestore.instance
    ...
    (value) {
      value.docs.forEach((element) {
        switch (element.id) {
          case "Design Visual":
            for (int i = 0; i < element["Skill yang dikuasai"].length; i++) {
  ...
  await FirebaseFirestore.instance
    ...
    (value) {
      value.docs.forEach((element) {
        switch (element.id) {
          case "designVisual":
            for (int i = 0; i < element["aplikasi yang dikuasai"].length; i++) {
              kodePilihanDesignVisual.add(element["aplikasi yang dikuasai"][i]);
            }
            break;
          ...
          case "programming":
            for (int i = 0; i < element["aplikasi yang dikuasai"].length; i++) {
              kodePilihanProgramming.add(element["aplikasi yang dikuasai"][i]);
            }
            break;
          case "security":
            for (int i = 0; i < element["aplikasi yang dikuasai"].length; i++) {
          ...
          case "videoEditor":
            for (int i = 0; i < element["aplikasi yang dikuasai"].length; i++) {
              kodePilihanVideoEditor.add(element["aplikasi yang dikuasai"][i]);
            }
            break;
        }
      });
      ...
      value.docs.forEach((element) {
        ...
        switch (element.id) {
          case "semester1":
            ...
            nilaiSems1.add(int.parse(element['Pengantar Teknologi Informasi']));
            break;
          case "semester2":
          ...
          case "semester3":
            ...
            nilaiSems3.add(int.parse(element['Jaringan Komputer Lanjut'])); //k
          ...
          case "semester4":
            ...
            nilaiSems4.add(int.parse(element['Perancangan User Experience']));
            break;
          case "semester5":
          ...
          case "semester6":
            ...
            nilaiSems6.add(int.parse(element['Pemograman Mobile'])); //mobile 7
            nilaiSems6
            ...
            nilaiSems6
                .add(int.parse(element['Sistem Web dan Mobile'])); // mobile 10
          ...
          case "semester7":
            ...
            nilaiSems7.add(int.parse(element['Jaringan Syaraf Tiruan'])); //i
            nilaiSems7.add(int.parse(element['Konten Digital'])); // m 3
            nilaiSems7.add(int.parse(element['Machine Learning'])); //i
            nilaiSems7.add(int.parse(element['Pemrosesan Bahasa Alami'])); //i
            nilaiSems7.add(int.parse(
                element['Sistem Forensik, Investigasi dan Respon'])); //k
            nilaiSems7.add(int.parse(element['Software Aplikasi Cluster'])); //k
...
class PortofolioAlumni extends StatelessWidget {
  const PortofolioAlumni({super.key});
  @override
                                                  ...
                                                  children: [
                                                    ...
                                                    ElevatedButton(
                                                        onPressed: () async {
                                                          try {
                                                            await FirebaseAuth
                                                                .instance.currentUser!.verifyBeforeUpdateEmail(emailBaru.text);
